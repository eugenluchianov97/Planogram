...
p.prototype = /** @lends Sortable.prototype */
{
  ...
  _appendGhost: function() {
    if (!g) {
      var e = this.options.fallbackOnBody ? document.body : T, n = M(c, true, Fe, true, e), o = this.options;
      if (Fe) {
  ...
  _onDragOver: function(e) {
    var n = this.el, o = e.target, r, i, a, l = this.options, s = l.group, u = p.active, d = Pe === s, f = l.sort, m = R || u, y, b = this, E = false;
    if (at)
      return;
    function k(ce, nn) {
      G(ce, b, te({
    ...
    function F(ce) {
      return k("dragOverCompleted", {
        insertion: ce
      }), ce && (d ? u._hideClone() : u._showClone(b), b !== m && (V(c, R ? R.options.ghostClass : u.options.ghostClass, false), V(c, l.ghostClass, true)), R !== b && b !== p.active ? R = b : b === p.active && R && (R = null), m === b && (b._ignoreWhileAnimating = o), b.animateAll(function() {
    ...
    if (c.contains(e.target) || o.animated && o.animatingX && o.animatingY || b._ignoreWhileAnimating === o)
      return F(false);
    if (We = false, u && !l.disabled && (d ? f || (a = A !== T) : R === this || (this.lastPutMode = Pe.checkPull(this, u, c, e)) && s.checkPut(this, u, c, e))) {
      if (y = this._getDirection(e, o) === "vertical", r = M(c), k("dragOverValid"), p.eventCanceled)
        return E;
      if (a)
        return A = T, H(), this._hideClone(), k("revert"), p.eventCanceled || (pe ? T.insertBefore(c, pe) : T.appendChild(c)), F(true);
      var L = dt(n, l.draggable);
      if (!L || Vn(e, y, this) && !L.animated) {
        if (L === c)
          return F(false);
        if (L && n === e.target && (o = L), o && (i = M(o)), Re(T, n, c, r, o, i, e, !!o) !== false)
          return H(), L && L.nextSibling ? n.insertBefore(c, L.nextSibling) : n.appendChild(c), A = n, x(), F(true);
      } else if (L && Un(e, y, this)) {
        var ne = we(n, 0, l, true);
        if (ne === c)
          return F(false);
        if (o = ne, i = M(o), Re(T, n, c, r, o, i, e, false) !== false)
          return H(), n.insertBefore(c, ne), A = n, x(), F(true);
        ...
        me !== o && (Q = i[N], Ie = false, Me = !w && l.invertSwap || v), j = $n(e, o, i, y, w ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Me, me === o);
        var C;
        if (j !== 0) {
          var X = K(c);
          do
            X -= j, C = A.children[X];
          while (C && (h2(C, "display") === "none" || C === g));
        }
        if (j === 0 || C === o)
          return F(false);
        me = o, Oe = j;
        ...
        if (ae !== false)
          return (ae === 1 || ae === -1) && (z = ae === 1), at = true, setTimeout(zn, 30), H(), z && !Y ? n.appendChild(c) : o.parentNode.insertBefore(c, z ? Y : o), I && jt(I, 0, _ - I.scrollTop), A = c.parentNode, Q !== void 0 && !Me && (Be = Math.abs(Q - M(o)[N])), x(), F(true);
      }
      if (n.contains(c))
        return F(false);
    }
  ...
  _showClone: function(e) {
    ...
    if (se) {
      if (G("showClone", this), p.eventCanceled)
        return;
      c.parentNode == T && !this.options.group.revertClone ? T.insertBefore(O, c) : pe ? T.insertBefore(O, pe) : T.appendChild(O), this.options.group.revertClone && this.animate(c, O), h2(O, "display", ""), se = false;
    }
  }
};
function jn(t) {
...
var rt = Gt(function(t, e, n, o) {
  if (e.scroll) {
    ...
    var f = 0, m = Se;
    do {
      var y = m, b = M(y), E = b.top, k = b.bottom, H = b.left, F = b.right, x = b.width, L = b.height, ne = void 0, j = void 0, Q = y.scrollWidth, v = y.scrollHeight, w = h2(y), N = y.scrollLeft, I = y.scrollTop;
      ...
      if (!P[f])
        for (var X = 0; X <= f; X++)
          P[X] || (P[X] = {});
      (P[f].vx != _ || P[f].vy != C || P[f].el !== y) && (P[f].el = y, P[f].vx = _, P[f].vy = C, clearInterval(P[f].pid), (_ != 0 || C != 0) && (u = true, P[f].pid = setInterval((function() {
...
function tn(...t) {
  ...
  function d(v) {
    ...
    const _ = unref((X = unref(r)) == null ? void 0 : X[N]), C = s(_);
    Ft(_, C), I[Rt] = C;
  }
  function f(v) {
    const w = v.item[Rt];
      ...
      if (X) {
        ...
        n == null || n.some((z, ae) => {
          if (Y && (n == null ? void 0 : n.length) !== _.childNodes.length)
            return I.insertBefore(Y, z.nextSibling), true;
  ...
  }, L = () => x == null ? void 0 : x.option("disabled", true), ne = () => x == null ? void 0 : x.option("disabled", false);
  return to(() => {
    l && F();
