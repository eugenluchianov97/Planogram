...
var _withId = withScopeId("data-v-060ca318");
...
var render$1 = _withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return openBlock(), createBlock("li", null, [
    _ctx.page === null ? (openBlock(), createBlock("span", _hoisted_1$1, [
    ...
    }, toDisplayString(_ctx.page), 15, ["aria-label"]))
  ]);
});
...
var _withId$1 = withScopeId("data-v-2a30deb0");
pushScopeId("data-v-2a30deb0");
var _hoisted_1$6 = { class: "Pagination" };
var _hoisted_2$5 = {
  key: 0,
  class: "PaginationControl"
};
var _hoisted_3 = { class: "PaginationControl" };
var _hoisted_4 = { class: "PaginationControl" };
var _hoisted_5 = {
  key: 1,
  class: "PaginationControl"
};
popScopeId();
var render$6 = _withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return openBlock(), createBlock("ul", _hoisted_1$6, [
    !_ctx.hideFirstButton ? (openBlock(), createBlock("li", _hoisted_2$5, [
    ...
    (openBlock(true), createBlock(
      Fragment,
      null,
      renderList(_ctx.pagination, (page) => {
    ...
    !_ctx.hideLastButton ? (openBlock(), createBlock("li", _hoisted_5, [
...
var vue3_pagination_esm_default = script$1;
export {
  vue3_pagination_esm_default as default
};
//# sourceMappingURL=@hennge_vue3-pagination.js.map
